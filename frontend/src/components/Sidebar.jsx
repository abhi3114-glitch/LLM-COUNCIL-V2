        ...
        <div className="config-item">
          <label className="debate-toggle">
            <input
              type="checkbox"
              checked={debateMode}
              onChange={(e) => onToggleDebateMode(e.target.checked)}
            />
            Debate Mode
          </label>
        </div>
      ...
      <div className="sidebar-footer">
        <div className="credits">
          ...
          <div className="social-links">
            <a href="https://github.com/abhi3114-glitch" target="_blank" rel="noopener noreferrer" title="GitHub">
            ...
            <a href="https://www.linkedin.com/in/abhishek-pratap-singh-chauhan-5431a828a" target="_blank" rel="noopener noreferrer" title="LinkedIn">
